...
import validatePhone from '../validators/validate-phone';
...
const RegisterComponent = (props) => {
    ...
    let emailErrorMessage, nameErrorMessage, passwordErrorMessage, phoneErrorMessage;
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  onKeyUp={(ev) => validatePhoneField(ev.target.value)}
                  onBlur={(ev) => validatePhoneField(ev.target.value)}
                  name="phone"
                  autoComplete="phone"
